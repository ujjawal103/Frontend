...
const StoreLogin = () => {
  ...
  return (
    ...
    <Helmet>
  <title>Store Login – Tap Resto Restaurant Management App</title>
  <meta
    name="description"
    content="Login to your Tap Resto store dashboard to manage orders, menu, tables, billing and analytics in one place."
  />
</Helmet>
